...
- $24.99 for [Kubikos 3D Cube World](https://assetstore.unity.com/packages/3d/environments/kubikos-3d-cube-world-117341)  There are also similarly priced packs for a village, city, and characters, animals, and a super active dev
- $5.99 for 7 characters and some village props, rigged, recent release,
- $5.99 [Mushrooms](https://assetstore.unity.com/packages/3d/vegetation/low-poly-mushrooms-pack-143548)
- $4.99 [Cartoon Adventure Characters](https://assetstore.unity.com/packages/3d/characters/cartoon-adventure-characters-pack-136942) Animated, Super Cute, Recent Release
...
- $40 [Micro Monsters] Super cute low poly ball shaped monsters, 7 of them, recent update, good reviews
- $20 Low poly [Micro Monsters] faceted cute monsters, looks like they can be recolored too to make different enemies, and that they have some variations.
- $50 [Toon Enemies Pack](https://assetstore.unity.com/packages/3d/characters/toon-enemies-pack-50421)  also theres a [second pack](https://assetstore.unity.com/packages/3d/characters/toon-enemies-pack-2-64355)
- $20 Low Poly [Space Invaders](https://www.cgtrader.com/3d-models/character/fantasy/low-poly-space-invader-set)
- $10.50 Shard Saga [Enemy Goblin Pack](https://www.cgtrader.com/3d-models/character/fantasy/shard-saga-enemy-goblin-pack) Interchangeable parts, No Textures (all vertex shaded, one material), rigged for shard saga animations
...
- $Free [Quaternius](https://www.patreon.com/quaternius) [Or here also](http://quaternius.com/assets.html) Some Complete nature packs, characters, some enemies, all low poly.
...
- $3.00 [Block World Pack](https://devilsworkshop.itch.io/essential-low-poly-isometric-3d-block-and-hex-pack)
...
- $7 [Toon Slimes](https://assetstore.unity.com/packages/3d/characters/toon-slimes-pack-64236) Three levels and 3 colors of slimes, plus there are a few other enemies like this in the same style for about the same price.
